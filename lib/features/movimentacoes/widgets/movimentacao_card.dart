...
class MovimentacaoCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Semantics(
      button: true,
      label:
          '$tipoLabel de ${movimentacao.produto}, fornecedor ${movimentacao.fornecedor}, quantidade ${movimentacao.quantidade} unidades, valor ${movimentacao.valorFormatado}, data ${movimentacao.dataFormatada}. Toque duas vezes para abrir os detalhes.',
